...
CREATE TABLE `enzo`.`autos` ( `id` INT NOT NULL AUTO_INCREMENT , `marca` VARCHAR(200) NULL , `modelo` VARCHAR(200) NULL , `nombre` VARCHAR(200) NULL , `descripcion` VARCHAR(200) NOT NULL , `color` VARCHAR(100) NOT NULL , `cantidad_de_puertas` INT(20) NOT NULL , `es_nuevo` VARCHAR(50) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; 

CREATE TABLE `enzo`.`marca` ( `id` INT NOT NULL AUTO_INCREMENT , `nombre` VARCHAR(150) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB; 